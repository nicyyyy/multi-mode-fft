...
%%
%fft与ifft结果比较
f1=fopen('E:\my_verilog\adv\fft\doc\y_re_fft256.txt','r');
[y_re_fft,num1]=fscanf(f1,'%04x',[1 inf]);
f2=fopen('E:\my_verilog\adv\fft\doc\y_im_fft256.txt','r');
...
f1=fopen('E:\my_verilog\adv\fft\doc\y_re_ifft256.txt','r');
[y_re_ifft,num1]=fscanf(f1,'%04x',[1 inf]);
f2=fopen('E:\my_verilog\adv\fft\doc\y_im_ifft256.txt','r');
